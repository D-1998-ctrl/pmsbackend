...
const createChatTemplate = async (req, res) => {
    const { templatename, from, chatsubject, description, sendreminderstoclient, daysuntilnextreminder, numberofreminders, clienttasks, active } = req.body;
    ...
    try {
        ...
        const newChatTemplate = await ChatTemplate.create({templatename, from, chatsubject, description, sendreminderstoclient, daysuntilnextreminder, numberofreminders, clienttasks, active });
