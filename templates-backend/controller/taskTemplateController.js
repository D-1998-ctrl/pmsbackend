...
const createTaskTemplate = async (req, res) => {
    const { templatename, status, description, taskassignees, tasktags, priority, absolutedates, startsin, startsinduration, duein, dueinduration, startdate, enddate, subtasks, active } = req.body;
    ...
    try {
        ...
        const newTaskTemplate = await TaskTemplate.create({ templatename, status, description, taskassignees, tasktags, priority, absolutedates, startsin, startsinduration, duein, dueinduration, startdate, enddate, subtasks, active});
...
const getTaskTemplateList = async (req, res) => {
    ...
    try {
        const taskTemplate = await TaskTemplate.findById(id)
         ...
         .populate({ path: 'tasktags', model: 'tag' });
